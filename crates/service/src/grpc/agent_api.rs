...
fn probing_to_config_response(p: &crate::probing::ProbingSection) -> ConfigResponse {
    ConfigResponse {
        ...
        icmp_thresholds: Some(PbProtocolThresholds {
            unhealthy_trigger_ratio: p.icmp_thresholds.unhealthy_trigger_ratio,
            healthy_recovery_ratio: p.icmp_thresholds.healthy_recovery_ratio,
        ...
        tcp_thresholds: Some(PbProtocolThresholds {
            unhealthy_trigger_ratio: p.tcp_thresholds.unhealthy_trigger_ratio,
            healthy_recovery_ratio: p.tcp_thresholds.healthy_recovery_ratio,
        ...
        udp_thresholds: Some(PbProtocolThresholds {
            unhealthy_trigger_ratio: p.udp_thresholds.unhealthy_trigger_ratio,
            healthy_recovery_ratio: p.udp_thresholds.healthy_recovery_ratio,
        ...
        path_health_thresholds: Some(PbPathHealthThresholds {
            degraded_trigger_ratio: p.path_health_thresholds.degraded_trigger_ratio,
            ...
            normal_recovery_ratio: p.path_health_thresholds.normal_recovery_ratio,
