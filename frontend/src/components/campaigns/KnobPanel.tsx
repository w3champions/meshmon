...
const DIVERSITY_HINT = "Spread probes across as many distinct paths as possible.";
const OPTIMIZATION_HINT = "Prioritise probes most likely to catch regressions.";
